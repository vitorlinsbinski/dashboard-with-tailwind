  ...
  return (
    <Select.Portal>
      <Select.Content
        ...
        side="bottom"
        position="popper"
        className="group z-10 w-[var(--radix-select-trigger-width)] animate-slideDownAndFade overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm will-change-[opacity,transform] dark:border-zinc-700 dark:bg-zinc-800"
      >
